# trace.asm
  ...
  .data
fmt0:
  .asciz "8x8 SINGLE PRECISION FLOATING POINT MATRIX TRACE\n"
fmt1:
  .asciz "\nThis is the matrix:\n"
fmt2:
  .asciz "\nThis is the trace (sequential version): %f\n"
fmt5:
  .asciz "This is the trace (AVX blend version): %f\n"
fmt6:
  .asciz "\nThis is the tranpose: \n"
fmt30:
  .asciz "Sequential version elapsed cycles: %u\n"
fmt31:
  .asciz "AVX blend version elapsed cycles: %d\n\n"
fmt4:
  .asciz "\nNumber of loops: %d\n"
  .align 32
matrix:
  ...
  .float 49., 50., 51., 52., 53., 54., 55., 56.
  .float 57., 58., 59., 60., 61., 62., 63., 64.
loops:
  .quad 1000
permps:
  .int 0, 1, 4, 5, 2, 3, 6, 7 # mask for permutation sp values in ymm
...
.loop2:
  ...
  vblendps ymm0, ymm0, ymm1, 0b00000010
  vblendps ymm0, ymm0, ymm2, 0b00000100
  vblendps ymm0, ymm0, ymm3, 0b00001000
  vblendps ymm0, ymm0, ymm4, 0b00010000
  vblendps ymm0, ymm0, ymm5, 0b00100000
  vblendps ymm0, ymm0, ymm6, 0b01000000
  vblendps ymm0, ymm0, ymm7, 0b10000000
  ...
  .data
.fmt:
  .asciz "%.f,\9%.f,\9%.f,\9%.f,\9%.f,\9%.f,\9%.f,\9%.f\n"
